    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.pay}>
          <Text style={styles.lab}>Ramada Encore By Wyndham Indore</Text>
          <Text style={styles.lab}>#12 of 501 hotels in Indore.</Text>
          <Text style={styles.lab}>📍- 150/3 Hare Krishna Vihaar, Near Iskcon Temple, Nipania, Indore , India.</Text>
