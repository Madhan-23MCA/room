    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.pay}>
          <Text style={styles.lab}>Enrise By Sayaji Rau Indore</Text>
          <Text style={styles.lab}>Enrise By Sayaji Indore has a garden, fitness center, a bar and shared lounge in Indore.</Text>
          <Text style={styles.lab}>📍- 27/1 27/2 Village Pigdambar Tehsil Mhow, Indore 453331 , India.</Text>
