    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.pay}>
          <Text style={styles.lab}>OYO 4042 Hotel Mehar Residency</Text>
          <Text style={styles.lab}>How to Reach While hiring a taxi/auto-rickshaw from anywhere in the city to the hotel .</Text>
          <Text style={styles.lab}>📍- 13 Residency Kibe Compound Behind Mdhumilan Talkies, Indore 452001 , India</Text>
