    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.pay}>
          <Text style={styles.lab}>Hotel Royal Savoy</Text>
          <Text style={styles.lab}>Hotel Royal Savoy is a luxurious 4* hotel situated behind the heritage Shalimar Mughal Gardens. The property has on viewing Chinar Trees of the Heritage Shalimar Bagh. Hotel offers all modern facilities, centrally Air conditioning Rooms , luxury rooms .</Text>
          <Text style={styles.lab}>📍- Behind Shalimar Garden, Srinagar , Kashmir - 190023 , India.</Text>
